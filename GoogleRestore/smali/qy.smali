...
.method public constructor <init>(Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Lqy;->e:Landroid/support/v7/widget/RecyclerView;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    sget-object v0, Landroid/support/v7/widget/RecyclerView;->N:Landroid/view/animation/Interpolator;

    iput-object v0, p0, Lqy;->d:Landroid/view/animation/Interpolator;
    ...
    iput-object v0, p0, Lqy;->c:Landroid/widget/OverScroller;
...
.method private final c()V
    ...
    iget-object v0, p0, Lqy;->e:Landroid/support/v7/widget/RecyclerView;
...
.method public final a(IIILandroid/view/animation/Interpolator;)V
    ...
    iget-object v4, p0, Lqy;->e:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 73
    sget-object p4, Landroid/support/v7/widget/RecyclerView;->N:Landroid/view/animation/Interpolator;

    :cond_4
    iget-object p3, p0, Lqy;->d:Landroid/view/animation/Interpolator;

    if-eq p3, p4, :cond_5

    iput-object p4, p0, Lqy;->d:Landroid/view/animation/Interpolator;

    new-instance p3, Landroid/widget/OverScroller;

    iget-object v1, p0, Lqy;->e:Landroid/support/v7/widget/RecyclerView;
    ...
    iput-object p3, p0, Lqy;->c:Landroid/widget/OverScroller;
    ...
    iget-object p3, p0, Lqy;->e:Landroid/support/v7/widget/RecyclerView;

    .line 75
    invoke-virtual {p3, v0}, Landroid/support/v7/widget/RecyclerView;->a(I)V

    iget-object v1, p0, Lqy;->c:Landroid/widget/OverScroller;
...
.method public final b()V
    ...
    iget-object v0, p0, Lqy;->c:Landroid/widget/OverScroller;
...
.method public final run()V
    ...
    iget-object v2, v1, Landroid/support/v7/widget/RecyclerView;->k:Lqk;

    if-nez v2, :cond_0

    .line 5
    invoke-virtual/range {p0 .. p0}, Lqy;->b()V
    ...
    iput-boolean v2, v0, Lqy;->g:Z

    const/4 v3, 0x1

    iput-boolean v3, v0, Lqy;->f:Z
    ...
    iget-object v7, v0, Lqy;->e:Landroid/support/v7/widget/RecyclerView;

    iget-object v10, v7, Landroid/support/v7/widget/RecyclerView;->L:[I
    ...
    iget-object v4, v0, Lqy;->e:Landroid/support/v7/widget/RecyclerView;

    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->L:[I
    ...
    iget-object v7, v4, Landroid/support/v7/widget/RecyclerView;->j:Lqc;

    if-eqz v7, :cond_6

    iget-object v7, v4, Landroid/support/v7/widget/RecyclerView;->L:[I
    ...
    iget-object v9, v4, Landroid/support/v7/widget/RecyclerView;->k:Lqk;

    .line 22
    iget-object v9, v9, Lqk;->t:Lqw;

    if-eqz v9, :cond_5

    iget-boolean v10, v9, Lqw;->d:Z

    if-nez v10, :cond_5

    iget-boolean v10, v9, Lqw;->e:Z

    if-eqz v10, :cond_5

    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->G:Lqx;

    .line 23
    invoke-virtual {v4}, Lqx;->a()I
    ...
    .line 24
    invoke-virtual {v9, v8, v7}, Lqw;->a(II)V
    ...
    :cond_7
    iget-object v14, v0, Lqy;->e:Landroid/support/v7/widget/RecyclerView;

    iget-object v4, v14, Landroid/support/v7/widget/RecyclerView;->L:[I
    ...
    iget-object v9, v4, Landroid/support/v7/widget/RecyclerView;->L:[I
    ...
    .line 39
    :goto_5
    iget-object v9, v0, Lqy;->e:Landroid/support/v7/widget/RecyclerView;

    iget-object v10, v9, Landroid/support/v7/widget/RecyclerView;->k:Lqk;

    .line 40
    iget-object v10, v10, Lqk;->t:Lqw;

    if-eqz v10, :cond_f

    iget-boolean v10, v10, Lqw;->d:Z
    ...
    .line 42
    :goto_7
    iget-object v5, v0, Lqy;->e:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 55
    :cond_18
    invoke-static {v5}, Lge;->d(Landroid/view/View;)V

    :cond_19
    iget-object v1, v0, Lqy;->e:Landroid/support/v7/widget/RecyclerView;

    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->F:Lou;

    .line 56
    invoke-virtual {v1}, Lou;->a()V
    ...
    :cond_1a
    :goto_a
    invoke-virtual/range {p0 .. p0}, Lqy;->a()V

    iget-object v1, v0, Lqy;->e:Landroid/support/v7/widget/RecyclerView;

    iget-object v4, v1, Landroid/support/v7/widget/RecyclerView;->E:Low;
    ...
    .line 59
    iget-object v1, v1, Lqk;->t:Lqw;

    if-eqz v1, :cond_1c

    iget-boolean v4, v1, Lqw;->d:Z

    if-eqz v4, :cond_1c

    .line 60
    invoke-virtual {v1, v2, v2}, Lqw;->a(II)V

    :cond_1c
    iput-boolean v2, v0, Lqy;->f:Z
    ...
    .line 61
    invoke-direct/range {p0 .. p0}, Lqy;->c()V
