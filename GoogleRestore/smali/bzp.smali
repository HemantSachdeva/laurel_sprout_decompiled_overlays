...
.method static a(Landroid/content/Context;)Landroid/content/pm/PackageStats;
    ...
    sget-object p0, Lbzp;->a:Lcua;

    invoke-virtual {p0}, Lctx;->a()Lcup;
    ...
    invoke-interface {p0, v4, v3, v0, v2}, Lctz;->a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V

    const-string v0, "StorageManager is not available"

    invoke-interface {p0, v0}, Lctz;->a(Ljava/lang/String;)V
    ...
    .line 15
    invoke-static {v7}, Lbzp;->a(Landroid/os/storage/StorageVolume;)Ljava/util/UUID;
    ...
    .line 19
    invoke-static {v6, v8, v7}, Lbzp;->a(Landroid/content/pm/PackageStats;Landroid/app/usage/StorageStats;Z)V
    :try_end_1
    ...
    :goto_1
    :try_start_2
    sget-object v8, Lbzp;->a:Lcua;

    invoke-virtual {v8}, Lctx;->b()Lcup;
    ...
    invoke-interface {v8, v4, v3, v7, v2}, Lctz;->a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V

    const-string v7, "queryStatsForPackage() call failed"

    invoke-interface {v8, v7}, Lctz;->a(Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-interface {v0, v4, v3, p0, v2}, Lctz;->a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
...
.method private static a(Landroid/os/storage/StorageVolume;)Ljava/util/UUID;
    ...
    invoke-interface {v3, v2, v1, v4, v0}, Lctz;->a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V

    const-string v4, "UUID for %s"

    invoke-interface {v3, v4, p0}, Lctz;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v4, v0, p0}, Lctz;->a(Ljava/lang/String;Ljava/lang/Object;)V
