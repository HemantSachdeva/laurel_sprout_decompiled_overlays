...
.method public final a(Lcom/google/android/material/textfield/TextInputLayout;)V
    ...
    .line 1
    invoke-static {v0}, Lcjz;->a(Landroid/widget/EditText;)Landroid/widget/AutoCompleteTextView;

    move-result-object v0

    iget-object v1, p0, Lcjt;->a:Lcjz;

    iget-object v2, v1, Lcjz;->k:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    .line 34
    iget-object v1, v1, Lcjz;->g:Landroid/graphics/drawable/StateListDrawable;
    ...
    .line 4
    invoke-static {v0}, Lcjz;->b(Landroid/widget/EditText;)Z
    ...
    :cond_4
    :goto_1
    iget-object v2, v2, Lcom/google/android/material/textfield/TextInputLayout;->i:Lchl;

    const v7, 0x7f0400a8

    .line 5
    invoke-static {v0, v7}, Lcsb;->a(Landroid/view/View;I)I
    ...
    .line 6
    invoke-static {v0, v1}, Lcsb;->a(Landroid/view/View;I)I
    ...
    .line 8
    invoke-virtual {v2}, Lchl;->a()Lchq;

    move-result-object v10

    invoke-direct {v6, v10}, Lchl;-><init>(Lchq;)V

    .line 9
    invoke-static {v7, v1, v9}, Lcrj;->a(IIF)I
    ...
    invoke-virtual {v6, v10}, Lchl;->a(Landroid/content/res/ColorStateList;)V

    .line 11
    invoke-virtual {v6, v1}, Lchl;->setTint(I)V
    ...
    invoke-direct {v7, v8}, Lchl;-><init>(Lchq;)V

    const/4 v8, -0x1

    .line 14
    invoke-virtual {v7, v8}, Lchl;->setTint(I)V
    ...
    .line 17
    invoke-static {v0, v2}, Lge;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    goto :goto_2

    :cond_5
    iget-object v1, v1, Lcjz;->k:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    .line 21
    invoke-static {v0, v6}, Lge;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 22
    invoke-direct {v2, v1, v0}, Lcjw;-><init>(Lcjz;Landroid/widget/AutoCompleteTextView;)V

    invoke-virtual {v0, v2}, Landroid/widget/AutoCompleteTextView;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V

    iget-object v2, v1, Lcjz;->b:Landroid/view/View$OnFocusChangeListener;
    ...
    invoke-direct {v2, v1}, Lcjx;-><init>(Lcjz;)V
    ...
    iget-object v1, v1, Lcjz;->a:Landroid/text/TextWatcher;
    ...
    iget-object v0, p0, Lcjt;->a:Lcjz;

    iget-object v0, v0, Lcjz;->m:Lcom/google/android/material/internal/CheckableImageButton;

    .line 31
    invoke-static {v0, v3}, Lge;->a(Landroid/view/View;I)V

    :cond_6
    iget-object v0, p0, Lcjt;->a:Lcjz;

    iget-object v0, v0, Lcjz;->c:Lckq;

    .line 32
    invoke-virtual {p1, v0}, Lcom/google/android/material/textfield/TextInputLayout;->a(Lckq;)V
