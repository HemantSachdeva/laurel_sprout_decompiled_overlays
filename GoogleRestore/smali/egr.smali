...
.field private static final c:Lcrm;

.field private static final d:Legp;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Legr;->a:Ljava/util/logging/Logger;

    new-instance v0, Legp;

    invoke-direct {v0}, Legp;-><init>()V

    sput-object v0, Legr;->d:Legp;

    new-instance v0, Legq;

    invoke-direct {v0}, Legq;-><init>()V

    sput-object v0, Legr;->c:Lcrm;
...
.method public constructor <init>()V
    ...
    sget-object v0, Legr;->c:Lcrm;

    sget-object v1, Legr;->d:Legp;
    ...
    .line 7
    :goto_0
    sget-object v2, Legr;->a:Ljava/util/logging/Logger;
    ...
    iput-object v2, p0, Legr;->b:Ljava/net/InetSocketAddress;
    ...
    iput-object v0, p0, Legr;->b:Ljava/net/InetSocketAddress;

    return-void
.end method

.method public static final a(Ljava/net/InetSocketAddress;)Ldym;
    .locals 13
    ...
    :try_start_0
    invoke-static {p0}, Ledp;->a(Ljava/net/InetSocketAddress;)Ljava/lang/String;
    ...
    sget-object p0, Legr;->a:Ljava/util/logging/Logger;
    ...
    sget-object v4, Legr;->a:Ljava/util/logging/Logger;
    ...
    .line 23
    invoke-static {v1}, Ledp;->a(Ljava/net/InetSocketAddress;)Ljava/lang/String;
    ...
    .line 26
    invoke-static {v2, v3, v4}, Legp;->a(Ljava/lang/String;Ljava/net/InetAddress;I)Ljava/net/PasswordAuthentication;
    ...
    .line 30
    invoke-virtual {v3, p0}, Ldwi;->a(Ljava/net/InetSocketAddress;)V

    .line 31
    invoke-virtual {v3, v1}, Ldwi;->a(Ljava/net/SocketAddress;)V

    if-nez v2, :cond_4

    .line 32
    invoke-virtual {v3}, Ldwi;->a()Ldwj;
    ...
    iput-object p0, v3, Ldwi;->a:Ljava/lang/String;
    ...
    :goto_0
    iput-object v0, v3, Ldwi;->b:Ljava/lang/String;
    ...
    sget-object v1, Legr;->a:Ljava/util/logging/Logger;
    ...
    sget-object v7, Legr;->a:Ljava/util/logging/Logger;
