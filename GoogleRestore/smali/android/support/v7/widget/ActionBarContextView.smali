...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    invoke-direct {p0, p1, p2, p3}, Llo;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 4
    sget-object v0, Ljh;->d:[I
    ...
    invoke-virtual {p1, p2, v1}, Lrn;->f(II)I
    ...
    invoke-virtual {p1, p2, v1}, Lrn;->e(II)I
...
.method public final a(Ljo;)V
    ...
    .line 19
    invoke-direct {v2, p1}, Llq;-><init>(Ljo;)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Ljo;->b()Landroid/view/Menu;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lmc;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lmc;

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lmc;

    .line 23
    invoke-virtual {v0}, Lmc;->h()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lmc;

    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->b:Landroid/content/Context;

    .line 25
    invoke-virtual {p1, v2, v3}, Lkp;->a(Lld;Landroid/content/Context;)V

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lmc;

    iget-object v2, p1, Lmc;->f:Llf;

    iget-object v3, p1, Lkc;->f:Llf;

    if-nez v3, :cond_3

    iget-object v3, p1, Lkc;->d:Landroid/view/LayoutInflater;
    ...
    iput-object v1, p1, Lkc;->f:Llf;

    iget-object v1, p1, Lkc;->f:Llf;

    iget-object v3, p1, Lkc;->c:Lkp;

    .line 27
    invoke-interface {v1, v3}, Llf;->a(Lkp;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/v7/widget/ActionMenuView;->a(Lmc;)V
    ...
    .line 31
    invoke-static {p1, v1}, Lge;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final onDetachedFromWindow()V
    ...
    .line 49
    invoke-super {p0}, Llo;->onDetachedFromWindow()V
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .line 57
    :cond_0
    invoke-super {p0, p1}, Llo;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
