...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Lgu;

    sget-object p2, Lgu;->a:Lgu;

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Lgu;

    sget-object p2, Lgu;->a:Lgu;

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lgu;

    sget-object p2, Lgu;->a:Lgu;

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Lgu;

    new-instance p2, Llr;

    .line 11
    invoke-direct {p2, p0}, Llr;-><init>(Landroid/support/v7/widget/ActionBarOverlayLayout;)V
    ...
    .line 12
    invoke-direct {p2, p0}, Lls;-><init>(Landroid/support/v7/widget/ActionBarOverlayLayout;)V
    ...
    .line 13
    invoke-direct {p2, p0}, Llt;-><init>(Landroid/support/v7/widget/ActionBarOverlayLayout;)V
...
.method private static final a(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    iput v0, p0, Llv;->topMargin:I

    const/4 v0, 0x1

    .line 20
    :cond_1
    iget v1, p0, Llv;->rightMargin:I
...
.method final a()V
    ...
    .line 174
    :goto_0
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Lnw;
...
.method public final a(Landroid/view/Menu;Llc;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Lnw;

    .line 186
    invoke-interface {v0, p1, p2}, Lnw;->a(Landroid/view/Menu;Llc;)V
...
.method public final a(Landroid/view/Window$Callback;)V
    ...
    .line 190
    invoke-interface {v0, p1}, Lnw;->a(Landroid/view/Window$Callback;)V
...
.method public final b(I)V
    ...
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Lnw;

    .line 53
    invoke-interface {p1}, Lnw;->f()V
...
.method public final bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Llv;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected final generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 37
    invoke-direct {v0, p1}, Llv;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Lft;
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    .line 60
    invoke-static {p1, p0}, Lgu;->a(Landroid/view/WindowInsets;Landroid/view/View;)Lgu;
    ...
    .line 61
    invoke-virtual {p1}, Lgu;->a()I

    move-result v1

    .line 62
    invoke-virtual {p1}, Lgu;->b()I

    move-result v2

    invoke-virtual {p1}, Lgu;->c()I

    move-result v3

    .line 63
    invoke-virtual {p1}, Lgu;->d()I
    ...
    .line 65
    invoke-static {p0, p1, v1}, Lge;->a(Landroid/view/View;Lgu;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, v1, v2, v3, v4}, Lgu;->b(IIII)Lgu;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Lgu;

    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Lgu;

    .line 67
    invoke-virtual {v2, v1}, Lgu;->equals(Ljava/lang/Object;)Z

    move-result v1

    if-nez v1, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Lgu;

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Lgu;
    ...
    .line 71
    :cond_2
    invoke-virtual {p1}, Lgu;->h()Lgu;

    move-result-object p1

    .line 72
    invoke-virtual {p1}, Lgu;->f()Lgu;

    move-result-object p1

    .line 73
    invoke-virtual {p1}, Lgu;->g()Lgu;
...
.method protected final onLayout(ZIIII)V
    ...
    .line 88
    iget v3, v0, Llv;->leftMargin:I

    add-int/2addr v3, p2

    .line 89
    iget v0, v0, Llv;->topMargin:I
...
.method protected final onMeasure(II)V
    ...
    iget v2, v0, Llv;->leftMargin:I

    add-int/2addr v1, v2

    iget v2, v0, Llv;->rightMargin:I
    ...
    iget v4, v0, Llv;->topMargin:I

    add-int/2addr v3, v4

    iget v0, v0, Llv;->bottomMargin:I
    ...
    .line 99
    invoke-static {p0}, Lge;->p(Landroid/view/View;)I
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Lgu;

    iput-object v6, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lgu;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lgu;

    .line 121
    invoke-virtual {v4, v2, v5, v2, v2}, Lgu;->b(IIII)Lgu;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lgu;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lgu;
    ...
    .line 106
    invoke-virtual {v4}, Lgu;->b()I

    move-result v4

    add-int/2addr v4, v5

    iget-object v5, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lgu;

    .line 107
    invoke-virtual {v5}, Lgu;->c()I

    move-result v5

    iget-object v6, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lgu;

    .line 108
    invoke-virtual {v6}, Lgu;->d()I

    move-result v6

    .line 109
    invoke-static {v2, v4, v5, v6}, Ldz;->a(IIII)Ldz;
    ...
    .line 111
    invoke-direct {v5, v4}, Lgm;-><init>(Lgu;)V
    ...
    .line 115
    invoke-direct {v5, v4}, Lgl;-><init>(Lgu;)V

    .line 116
    :goto_1
    invoke-virtual {v5, v2}, Lgn;->a(Ldz;)V

    .line 117
    invoke-virtual {v5}, Lgn;->a()Lgu;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Lgu;

    iget-object v4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lgu;

    invoke-virtual {v2, v4}, Lgu;->equals(Ljava/lang/Object;)Z
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Lgu;

    iget-object v4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->l:Landroid/support/v7/widget/ContentFrameLayout;

    .line 125
    invoke-static {v4, v2}, Lge;->b(Landroid/view/View;Lgu;)V
    ...
    iget v5, v2, Llv;->leftMargin:I

    iget v6, v2, Llv;->rightMargin:I
    ...
    iget v5, v2, Llv;->topMargin:I

    iget v2, v2, Llv;->bottomMargin:I
...
.method public final onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->g:Llu;

    if-eqz p1, :cond_1

    check-cast p1, Ljg;

    iget-object p2, p1, Ljg;->n:Ljx;

    if-eqz p2, :cond_1

    .line 153
    invoke-virtual {p2}, Ljx;->b()V

    const/4 p2, 0x0

    iput-object p2, p1, Ljg;->n:Ljx;
...
.method public final onWindowSystemUiVisibilityChanged(I)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->g:Llu;
    ...
    .line 168
    :cond_1
    iget-boolean p1, v2, Ljg;->m:Z

    if-nez p1, :cond_3

    iput-boolean v4, v2, Ljg;->m:Z

    .line 167
    invoke-virtual {v2, v4}, Ljg;->e(Z)V
...
.method protected final onWindowVisibilityChanged(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->g:Llu;
