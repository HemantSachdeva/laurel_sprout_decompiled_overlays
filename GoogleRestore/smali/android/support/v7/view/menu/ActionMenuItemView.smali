...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    invoke-direct {p0, p1, p2, p3}, Lnq;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private final g()V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lks;
    ...
    iget-object v2, v2, Lks;->l:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lks;->d:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lks;->m:Ljava/lang/CharSequence;
    ...
    .line 59
    :cond_5
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lks;

    iget-object v1, v0, Lks;->d:Ljava/lang/CharSequence;

    :goto_4
    invoke-static {p0, v1}, Laqc;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    .line 60
    :cond_6
    invoke-static {p0, v2}, Laqc;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final a(Lks;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lks;
    ...
    invoke-virtual {p0, v0, v2, v2, v2}, Lnq;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V

    .line 18
    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->g()V

    .line 19
    invoke-virtual {p1, p0}, Lks;->a(Lle;)Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Los;
    ...
    invoke-direct {p1, p0}, Lka;-><init>(Landroid/support/v7/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Los;
...
.method public final d()Z
    ...
    invoke-virtual {v0}, Lks;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Lko;
    ...
    .line 28
    invoke-interface {p1, v0}, Lko;->a(Lks;)Z
...
.method protected final onMeasure(II)V
    ...
    .line 33
    invoke-super {p0, v1, v2, v3, v4}, Lnq;->setPadding(IIII)V
    ...
    invoke-super {p0, p1, p2, v0, v1}, Lnq;->setPadding(IIII)V
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, p1}, Lnq;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 45
    invoke-virtual {v0}, Lks;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Los;
...
.method public final setPadding(IIII)V
    ...
    .line 48
    invoke-super {p0, p1, p2, p3, p4}, Lnq;->setPadding(IIII)V
