...
.method private final getSpringAnimation(Landroidx/dynamicanimation/animation/FloatPropertyCompat;Ljava/lang/Object;)Landroidx/dynamicanimation/animation/SpringAnimation;
    ...
    :cond_0
    const-string p0, "springAnimations.getOrPu\u2026    as SpringAnimation })"
...
.method public final cancelInternal$frameworks__base__packages__SystemUI__android_common__SystemUI_core(Ljava/util/Set;)V
    .locals 2
    .param p1    # Ljava/util/Set;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public final flingThenSpring(Landroidx/dynamicanimation/animation/FloatPropertyCompat;FLcom/android/systemui/util/animation/PhysicsAnimator$FlingConfig;Lcom/android/systemui/util/animation/PhysicsAnimator$SpringConfig;Z)Lcom/android/systemui/util/animation/PhysicsAnimator;
    ...
    .line 320
    invoke-virtual {p3}, Lcom/android/systemui/util/animation/PhysicsAnimator$FlingConfig;->getMin$frameworks__base__packages__SystemUI__android_common__SystemUI_core()F
    ...
    :cond_1
    invoke-virtual {p3}, Lcom/android/systemui/util/animation/PhysicsAnimator$FlingConfig;->getMax$frameworks__base__packages__SystemUI__android_common__SystemUI_core()F
    ...
    .line 325
    invoke-virtual {p3}, Lcom/android/systemui/util/animation/PhysicsAnimator$FlingConfig;->getFriction$frameworks__base__packages__SystemUI__android_common__SystemUI_core()F
    ...
    :cond_7
    :goto_2
    invoke-virtual {v1, p2}, Lcom/android/systemui/util/animation/PhysicsAnimator$FlingConfig;->setStartVelocity$frameworks__base__packages__SystemUI__android_common__SystemUI_core(F)V

    .line 361
    invoke-virtual {v2, v5}, Lcom/android/systemui/util/animation/PhysicsAnimator$SpringConfig;->setFinalPosition$frameworks__base__packages__SystemUI__android_common__SystemUI_core(F)V
...
.method public final getAnimatedProperties$frameworks__base__packages__SystemUI__android_common__SystemUI_core()Ljava/util/Set;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final getInternalListeners$frameworks__base__packages__SystemUI__android_common__SystemUI_core()Ljava/util/ArrayList;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final spring(Landroidx/dynamicanimation/animation/FloatPropertyCompat;FFLcom/android/systemui/util/animation/PhysicsAnimator$SpringConfig;)Lcom/android/systemui/util/animation/PhysicsAnimator;
    ...
    .line 201
    invoke-virtual {p4}, Lcom/android/systemui/util/animation/PhysicsAnimator$SpringConfig;->getStiffness$frameworks__base__packages__SystemUI__android_common__SystemUI_core()F

    move-result v5

    invoke-virtual {p4}, Lcom/android/systemui/util/animation/PhysicsAnimator$SpringConfig;->getDampingRatio$frameworks__base__packages__SystemUI__android_common__SystemUI_core()F
...
.method public final startInternal$frameworks__base__packages__SystemUI__android_common__SystemUI_core()V
    .locals 15
    ...
    .line 476
    invoke-virtual {p0}, Lcom/android/systemui/util/animation/PhysicsAnimator;->getAnimatedProperties$frameworks__base__packages__SystemUI__android_common__SystemUI_core()Ljava/util/Set;
    ...
    .line 519
    invoke-virtual {v14, v2}, Lcom/android/systemui/util/animation/PhysicsAnimator$SpringConfig;->applyToAnimation$frameworks__base__packages__SystemUI__android_common__SystemUI_core(Landroidx/dynamicanimation/animation/SpringAnimation;)V
    ...
    .line 524
    :cond_4
    invoke-virtual {v9}, Lcom/android/systemui/util/animation/PhysicsAnimator$FlingConfig;->getMin$frameworks__base__packages__SystemUI__android_common__SystemUI_core()F

    move-result v12

    .line 525
    invoke-virtual {v9}, Lcom/android/systemui/util/animation/PhysicsAnimator$FlingConfig;->getMax$frameworks__base__packages__SystemUI__android_common__SystemUI_core()F
